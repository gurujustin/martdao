...
import { ReactComponent as GlaImg } from "../assets/tokens/GLA.svg";
import { ReactComponent as SGlaImg } from "../assets/tokens/SGLA.svg";

import { gla_usdt } from "./AllBonds";
...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const gla_usdt_address = gla_usdt.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(gla_usdt_address, PairContract, provider);
...
export async function getTokenPrice(tokenId = "gla-dao") {
