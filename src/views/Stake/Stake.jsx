...
function Stake() {
  ...
  const onChangeStake = async (action) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(glaBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your GLA balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sGLA balance."));
    }
    await dispatch(
      changeStake({
        address,
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 2)} GLA</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
              ...
              <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake GLA</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("gla") && view === 0) || (!hasAllowance("sgla") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>GLA</b>?
                                    <br />
                                    Please approve Gla Dao to use your <b>GLA</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sGLA</b>?
                                    <br />
                                    Please approve Gla Dao to use your <b>sGLA</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake GLA")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(glaBalance, 4)} GLA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sGLA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sGLA</>}
                        </Typography>
                      </div>
